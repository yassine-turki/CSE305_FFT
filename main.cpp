...
//         file_path = "data/natural_gas_co2_emissions_for_electric_power_sector.csv";
    ...
    std::vector<int> intVector2 = {1, 2, 3, 4};
    ...
    std::vector<int> int_sum = multiply_polynomials_trivial(intVector, intVector2);
    for (const auto& c : int_sum) {
        std::cout << c <<" ";
    }
    std::cout<<"FFT"<<std::endl;
    std::vector<int> int_sum_2 = multiply_polynomials_FFT_int(intVector, intVector2);
